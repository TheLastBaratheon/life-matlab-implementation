...
len=500; 
lattice=int8(rand(len,len)); %defining array of dimensions(len,len)
up=[2:len 1]; down=[len 1:len-1]; 
colormap(gray(2)); %refer to http://matlab.izmiran.ru/help/techdoc/ref/colormap.html
for i=1:100
    ...
    image(lattice*2); pause(0.05) %generating a new image at each timestep of 0.05s
end
